...
public class DateUtils {
    ...
    public static String transUnixTimeStamp2Date(String timeStamp, String formater) {
        ...
        if (formater == null) {
            formater = DateUtils.DATATIME_FORMMATER;
        }
    ...
    public static String getDateByTimeMillis(Long time) {
        ...
        String data = DateUtils.dateToString(date, DateUtils.DATA_FORMATER);
        return data;
    }
    ...
    public static String getDateByTimeMilli(Long time) {
        Date date = new Date(time);
        String data = DateUtils.dateToString(date, DateUtils.DATATIME_FORMMATER3);
    ...
    public static String getSectTime(String SectBegin, String SectEnd) {
        Date date1 = DateUtils.StringToDate(SectBegin, DateUtils.DATATIME_FORMMATER);
        Date date2 = DateUtils.StringToDate(SectEnd, DateUtils.DATATIME_FORMMATER);
